...
public class LoginView extends JFrame {
    ...
    private void initializeUI() {
        ...
        headerLabel.setForeground(new Color(139, 69, 19)); // Brown color
        add(headerLabel, BorderLayout.NORTH);

        // Form panel
        JPanel formPanel = new JPanel(new GridBagLayout());
        formPanel.setBackground(new Color(245, 222, 179)); // Wheat color
        ...
        loginButton.setBackground(new Color(210, 105, 30)); // Chocolate color
    ...
    private void handleLogin() {
        ...
        if (result == null) {
            dispose();
            new SectionView().setVisible(true);
        } else {
