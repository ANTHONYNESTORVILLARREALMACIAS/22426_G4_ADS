...
public class Validator {
    ...
    public static boolean isValidUsuarioUsername(String username) {
        return username != null && username.trim().length() >= 4;
    }

    public static boolean isValidUsuarioNombre(String nombre) {
        return nombre != null && nombre.trim().length() >= 2;
    }

    public static boolean isValidUsuarioPassword(String password) {
